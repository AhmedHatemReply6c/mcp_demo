...
@mcp.tool()
async def get_mcp_doc() -> str:
    """Return a short MCP summary/documentation."""
    return MCP_DOC
...
async def generate_mcp_client_server_code(query: str) -> str:
    """
    Takes a natural-language specification of required tools and returns code.
    ...
    prompt = f"""\
/no_think You are an expert Python developer.
